export const roomsData = [
  {
    ...
    description:
      "Contemporary elegance in the city. Designed to embody both form and functionality with impeccable finishes from every angle. Offering unapologetic lavishness, every stay has a story in the 1 Bedroom Luxury Suite",
    rate: 177090,
    imageURLs: [
